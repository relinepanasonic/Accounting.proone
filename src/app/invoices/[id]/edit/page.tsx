...
export default async function EditInvoicePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { data: clients } = await supabase.from('clients').select('id, name, company_name, company_legal_name').eq('workspace_id', activeWorkspaceId).order('name', { ascending: true });
