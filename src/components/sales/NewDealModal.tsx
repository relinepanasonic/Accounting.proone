...
export function NewDealModal({ clients }: { clients: any[] }) {
  ...
  return (
    <>
      <button 
        ...
        className="bg-gradient-to-r from-[#d4af37] to-[#f5d77f] text-black font-bold hover:opacity-90 transition-opacity"
      >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-[#0e0f14] border border-[#d4af37]/20 rounded-xl w-full max-w-md overflow-hidden shadow-[0_0_40px_rgba(212,175,55,0.15)] animate-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center p-4 border-b border-zinc-800 bg-zinc-900/50">
              <h2 className="text-lg font-bold text-zinc-100 font-serif">Add New Deal</h2>
            ...
            <form onSubmit={handleSubmit} className="p-4 space-y-4">
              <div>
                <label className="block text-xs font-semibold text-zinc-400 uppercase tracking-wider mb-1.5">Deal Title</label>
                <input 
                  type="text" 
                  name="title" 
                  required 
              ...
              <div className="pt-2">
                <button 
                  type="submit" 
                  disabled={isPending}
                  className="w-full bg-gradient-to-r from-[#d4af37] to-[#f5d77f] text-black font-bold hover:opacity-90 transition-opacity disabled:opacity-50"
                >
